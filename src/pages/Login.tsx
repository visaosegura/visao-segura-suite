...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      {/* Background claro com gradiente sofisticado */}
      ...
      <div className="absolute top-1/2 left-10 w-24 h-24 bg-orange-500/5 rounded-full blur-lg animate-pulse delay-500"></div>
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight mb-3 bg-gradient-to-r from-slate-800 via-blue-600 to-orange-500 bg-clip-text text-transparent">
            Visão Segura
          </h1>
          <p className="text-slate-600 text-lg">Sistema de gestão de monitoramento</p>
        </div>

        {/* Card de login elegante */}
        <div className="bg-white/80 backdrop-blur-md border border-white/40 shadow-2xl rounded-2xl p-8 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 relative z-10">
            <div className="space-y-2">
              ...
              <Input
                ...
                {...register("email")}
                disabled={isLoading}
                className="bg-white/50 border-slate-200 text-slate-800 placeholder:text-slate-500 focus:border-orange-400 focus:ring-orange-400/20 h-12"
              />
              {errors.email && (
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  {...register("password")}
                  disabled={isLoading}
                  className="bg-white/50 border-slate-200 text-slate-800 placeholder:text-slate-500 focus:border-orange-400 focus:ring-orange-400/20 h-12 pr-12"
                />
                <button
                  type="button"
