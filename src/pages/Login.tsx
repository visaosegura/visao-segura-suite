...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      {/* Background moderno com gradiente sofisticado */}
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        {/* Logo original com design sofisticado */}
        <div className="text-center mb-8">
          <div className="mb-8">
            <div className="inline-flex items-center justify-center w-32 h-32 rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 mb-6 shadow-2xl">
              <img 
                src={logo} 
                alt="Visão Segura" 
          ...
          <h1 className="text-5xl font-bold tracking-tight mb-4 bg-gradient-to-r from-white via-orange-200 to-orange-400 bg-clip-text text-transparent">
            Visão Segura
          </h1>
          <p className="text-white/80 text-xl font-medium">Sistema de gestão de monitoramento</p>
        </div>

        {/* Card de login sofisticado */}
        <div className="bg-white/10 backdrop-blur-md border border-white/20 shadow-2xl rounded-2xl p-8 relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-orange-500/10 to-transparent -skew-x-12 transform -translate-x-full animate-pulse"></div>
